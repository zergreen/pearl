...
public class r1_2 {
    public static void main(String[] args) {
        ...
        String[] numTH = {  "ศูนย์", "หนึ่ง", "สอง", "สาม", "สี่", "ห้า", "หก", "เจ็ด", "แปด", "เก้า", 
                            ...
                            "เก้าสิบ", "เก้าสิบเอ็ด", "เก้าสิบสอง", "เก้าสิบสาม", "เก้าสิบสี่", "เก้าสิบห้า", "เก้าสิบหก", "เก้าสิบเจ็ด", "เก้าสิบแปด", "เก้าสิบเก้า", "หนึ่งร้อย"                         
                        };

        Scanner sc = new Scanner(System.in);
        int num = sc.nextInt();
        // int num = 91;
        System.out.println(numTH[num]);
